...
public partial class Asst_Report_Mr_Asset_Master_List_Rpt : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            SqlDataAdapter cmd = new SqlDataAdapter("Mr_Asset_Master_List_Rpt", R2m_Asst_Cnn);
            ...
            cmd.Fill(ds, "Mr_Asset_Master_List_Rpt");
