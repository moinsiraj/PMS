...
public partial class Asst_Report_Mr_Asset_Master_List_Info_Rpt : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            SqlDataAdapter cmd = new SqlDataAdapter("Mr_Asset_Summary_Rpt", R2m_Asst_Cnn);
            ...
            cmd.Fill(ds, "Mr_Asset_Summary_Rpt");
            ...
            reportParameters.Add(new ReportParameter("Title", "Asset Summary Report- Factory: " + Fact.ToString() + ""));
