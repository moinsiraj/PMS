...
public partial class Cutting_Report_R2m_CutSummary_Cut_Date_D2D : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            SqlDataAdapter cmd = new SqlDataAdapter("Mr_Cutting_WIP_X_Factory_Rpt_New", R2m_Smart_cnn);
            ...
            cmd.Fill(ds, "Mr_Cutting_WIP_X_Factory_Rpt_New");
