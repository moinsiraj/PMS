...
public partial class Cutting_Report_R2m_Cut_Style_Country_Rpt : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            SqlDataAdapter cmd = new SqlDataAdapter("Mr_Style_PO_Col_Country_Rpt", R2m_PMS_cnn);
            cmd.SelectCommand.CommandType = CommandType.StoredProcedure;
            cmd.SelectCommand.Parameters.AddWithValue("@Style", Style);
            cmd.SelectCommand.Parameters.AddWithValue("@PO", PO);
            cmd.SelectCommand.Parameters.AddWithValue("@Country", CNTRY);
    
            DataSet ds = new DataSet();
            cmd.Fill(ds, "Mr_Style_PO_Col_Country_Rpt");
