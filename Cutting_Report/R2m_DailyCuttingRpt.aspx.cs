...
public partial class Cutting_Report_R2m_DailyCuttingRpt : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            SqlDataAdapter cmd = new SqlDataAdapter("Sp_Web_GetDailyCuttingProd", R2m_Smart_cnn);
            ...
            cmd.Fill(ds, "Sp_Web_GetDailyCuttingProd");
            ...
            reportParameters.Add(new ReportParameter("Title", "Daily Cutting Report- Date: " + FromDate.ToString() + ""));
