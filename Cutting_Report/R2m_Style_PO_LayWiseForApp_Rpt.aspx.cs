...
public partial class Sewing_Report_R2m_Style_PO_LayWiseForApp_Rpt : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            reportParameters.Add(new ReportParameter("Title", "Lay Wise Cutting Report- Lay: " + Lay.ToString() + ""));
