...
public partial class Cutting_Report_R2m_Style_Wise_Cut_To_Input_Qty : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            reportParameters.Add(new ReportParameter("Title", "Style Wise Cut To Input Report"));
