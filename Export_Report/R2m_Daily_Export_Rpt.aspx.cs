...
public partial class Export_Report_R2m_Daily_Export_Rpt : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            SqlDataAdapter cmd = new SqlDataAdapter("Mr_Export_Daily_Rpt", R2m_PMS_cnn);
            ...
            cmd.Fill(ds, "Mr_Export_Daily_Rpt");
            ...
            reportParameters.Add(new ReportParameter("Title", "Daily Export Report- Date: " + FromDate.ToString() + ""));
