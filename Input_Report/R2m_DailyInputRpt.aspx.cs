...
public partial class Cutting_Report_R2m_DailyCuttingRpt : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            SqlDataAdapter cmd = new SqlDataAdapter("Mr_Daily_Input_Rpt", R2m_PMS_cnn);
            ...
            cmd.Fill(ds, "Mr_Daily_Input_Rpt");
            ...
            reportParameters.Add(new ReportParameter("Title", "Daily Line Wise Input Report- Date: " + FromDate.ToString() + ""));
