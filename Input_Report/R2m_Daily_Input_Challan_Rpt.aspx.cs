...
public partial class Input_Report_R2m_Daily_Input_Challan_Rpt : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            SqlDataAdapter cmd = new SqlDataAdapter("Mr_Input_Cut_Panel_Ref_Rpt", R2m_PMS_cnn);
            cmd.SelectCommand.CommandType = CommandType.StoredProcedure;
            cmd.SelectCommand.Parameters.AddWithValue("@InputRef", refno);          
            DataSet ds = new DataSet();
            cmd.Fill(ds, "Mr_Input_Cut_Panel_Ref_Rpt");
