...
public partial class Cutting_Report_R2m_Input_Summary_D2D : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            SqlDataAdapter cmd = new SqlDataAdapter("Mr_Cutting_WIP_X_Factory_Rpt", R2m_PMS_cnn);
