<%@ Page Title="Cutting Report" Language="C#" MasterPageFile="~/Master.master" AutoEventWireup="true" CodeFile="R2m_Asset_Report.aspx.cs" Inherits="R2m_Asset_Report" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="card card-info card-outline">
        <div class="card-header">
            <h3 class="card-title right animate-charcter"><i class="far fa-file-alt">Asset Report</i></h3>
        </div>
        <div class="card-body">
                                            ...
                                            <div class="col-md-7">
                                                <div class="card card-info border border-info">
                                                    ...
                                                    <div class="card-body">
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <asp:RadioButton ID="RB1" runat="server" AutoPostBack="True" Font-Size="13px" GroupName="a" Text="Asset Management Report" OnCheckedChanged="RB1_CheckedChanged" /><br />
                                                                <asp:RadioButton ID="RB2" runat="server" AutoPostBack="True" Font-Size="13px" GroupName="a" OnCheckedChanged="RB2_CheckedChanged" Text="Asset Information Details" /><br />
                                                                <asp:RadioButton ID="RB3" runat="server" AutoPostBack="True" Font-Size="13px" GroupName="a" Text="Asset Detail Summary Report" /><br />
                                                                <asp:RadioButton ID="RB4" runat="server" AutoPostBack="True" Font-Size="13px" GroupName="a" Text="Asset Summary Report" /><br />

                                                                <asp:RadioButton ID="RB5" runat="server" AutoPostBack="True" Font-Size="13px" GroupName="a" Text="Running Repair Report" /><br />

                                                            </div>
                                                            <div class="col-md-6">
                                                                <asp:RadioButton ID="RB6" runat="server" AutoPostBack="True" Font-Size="13px" GroupName="a" Text="Internal Fixed Asset Transfer Report" /><br />
                                                                <asp:RadioButton ID="RB7" runat="server" AutoPostBack="True" Font-Size="13px" GroupName="a" Text="Internal Fixed Asset Transfer Report" /><br />
                                                                <asp:RadioButton ID="RB8" runat="server" AutoPostBack="True" Font-Size="13px" GroupName="a" Text="External Fixed Asset Transfer Report" /><br />
                                                                <asp:RadioButton ID="RB9" runat="server" AutoPostBack="True" Font-Size="13px" GroupName="a" Text="Rented Asset Details Report" /><br />
                                                                <asp:RadioButton ID="RB10" runat="server" AutoPostBack="True" Font-Size="13px" GroupName="a" Text="Scheduled Maintenance Report" /><br />
                                                                <asp:RadioButton ID="RB11" runat="server" AutoPostBack="True" Font-Size="13px" GroupName="a" Text="Asset Management Detail Master Report" /><br />
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label>Line No</label>
                                                                    <asp:DropDownList ID="DDLAYNO" runat="server" CssClass="form-control form-control-sm">
                                                                    </asp:DropDownList>
                                                                </div>
                                                            </div>
                                                        </div>
