<%@ Page Title="Input Button Production" Language="C#" MasterPageFile="~/Master.master" AutoEventWireup="true" CodeFile="R2m_Button_Pro.aspx.cs" Inherits="R2m_Button_Pro" %>
        ...
        function CheckValue() {
            var SewBalance = parseInt(document.getElementById('<%=TxtSewBal.ClientID %>').value);
               ...
               if (SewingQty > SewBalance) {
                   alert('Button Qty Cannot Be Greater Than Balance Qty');
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-secondary">
                            ...
                            <div class="card-header">
                                <h3 class="card-title"><i class="fas fa-tshirt"></i>Input Button Information</h3>
                            </div>
                            <!--card-body -->
                            <div class="card-body">
                                                            ...
                                                            <div class="card-body">
                                                                <div class="border border-info p-1 mb-1">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-md-2">
                                                                            <div class="form-group">
                                                                                <label style="font-size: x-small">Button Qty</label>
                                                                        ...
                                                                        <div class="col-md-2">
                                                                            <div class="form-group">
                                                                                <label style="font-size: x-small;">Total Wash Qty</label>
                                                                        ...
                                                                        <div class="col-md-2">
                                                                            <div class="form-group">
                                                                                <label style="font-size: x-small;">Total Button Qty</label>
