<%@ Page Title="CM Earning Report" Language="C#" MasterPageFile="~/Master.master" AutoEventWireup="true" CodeFile="R2m_CM_Report.aspx.cs" Inherits="R2m_CM_Report" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="card card-info card-outline">
        <div class="card-header">
            <h3 class="card-title"><i class="far fa-file-alt">CM Report</i></h3>
        </div>
        <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col-md-7">
                                                <div class="card card-info border border-info">
                                                    <div class="card-header">
                                                        <h3 class="card-title"><i class="fas fa-th-list">Report List</i></h3>
                                                    </div>
                                                    <div class="card-body">
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <asp:RadioButton ID="RB2" runat="server" AutoPostBack="True" Font-Size="13px" GroupName="a" Text="Daily Earn CM Report" OnCheckedChanged="RB2_CheckedChanged" /><br />
                                                                <asp:RadioButton ID="RB14" runat="server" AutoPostBack="True" Font-Size="13px" GroupName="a" Visible="false" OnCheckedChanged="RB11_CheckedChanged" Text="Cutting Summary By- ExFactory D2D" /><br />
                                                                <asp:RadioButton ID="RB1" runat="server" AutoPostBack="True" Font-Size="13px" GroupName="a" Visible="false" Text="Cutting Report- Style Wise" OnCheckedChanged="RB1_CheckedChanged" /><br />
                                                                <asp:RadioButton ID="RB13" runat="server" AutoPostBack="True" Font-Size="13px" GroupName="a" Visible="false" OnCheckedChanged="RB13_CheckedChanged" Text="Cutting Report- PO Wise" /><br />

                                                                <asp:RadioButton ID="RB3" runat="server" AutoPostBack="True" Font-Size="13px" GroupName="a" Visible="false" OnCheckedChanged="RB3_CheckedChanged" Text="Cutting Report-Lay Wise" /><br />
                                            ...
                                            <div class="col-md-5">
                                                <div class="card card_cus card-info border border-info">
                                                    <div class="card-header">
                                                        <h3 class="card-title"><i class="fas fa-align-justify">Report Parameter's</i></h3>
                                                    </div>
                                                    <div class="card-body">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                   <%-- <label>Color</label>
                                                                    <asp:DropDownList ID="DDCOLOR" runat="server" CssClass="form-control form-control-sm">
                                                                    </asp:DropDownList>--%>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6">
