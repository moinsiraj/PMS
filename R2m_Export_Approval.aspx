<%@ Page Title="Export For Approval" Language="C#" MasterPageFile="~/Master.master" AutoEventWireup="true" CodeFile="R2m_Export_Approval.aspx.cs" Inherits="R2m_Export_Approval" %>
                        ...
                        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                            <ContentTemplate>
                                        ...
                                        <asp:GridView ID="GVINPUTFORAPP" runat="server" AutoGenerateColumns="False" CssClass="table table-bordered table-hover table-sm"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Report" ItemStyle-Width="80px">
                                                    <ItemTemplate>
                                                        <asp:LinkButton ID="LinkButton1" runat="server" CausesValidation="False" CommandArgument='<%# Bind("exp_ref") %>'
                                                            CommandName="report">Report <i class="far fa-file-pdf" style="color:#E34736"></i></asp:LinkButton>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="Challan No">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblRef" runat="server" Text='<%# Bind("exp_ref") %>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:BoundField DataField="sew_factory" HeaderText="Sewing Factory" ItemStyle-HorizontalAlign="Center" />
                                                <asp:BoundField DataField="shift_from" HeaderText="Company" ItemStyle-HorizontalAlign="left" />
                                                <asp:BoundField DataField="exp_del_to" HeaderText="Delivery To" ItemStyle-HorizontalAlign="left" />
                                                <asp:BoundField DataField="exp_qty" HeaderText="Export Qty (Pcs)" ItemStyle-HorizontalAlign="Center" />
                                                <asp:BoundField DataField="exp_ctnQty" HeaderText="Carton Qty" ItemStyle-HorizontalAlign="Center" />
                                                                           <asp:BoundField DataField="exp_date" HeaderText="Export Date" DataFormatString="{0:dd/MMM/yyyy}" ItemStyle-HorizontalAlign="Center" />
                                        
                                                <asp:BoundField DataField="exp_input_user" HeaderText="Created By" ItemStyle-HorizontalAlign="Center" />
                                                <asp:BoundField DataField="exp_input_date" HeaderText="Created Date" DataFormatString="{0:dd/MMM/yyyy}" ItemStyle-HorizontalAlign="Center" />
                                            </Columns>
                                ...
                                <div class="mt-2" style="border: 1px solid #99CCFF; height: 40px; padding: 2px; background-color: rgba(40,167,69,0.28)">
                                    ...
                                    <asp:LinkButton class="btn btn-warning btn-sm float-right" Style="font-size: 14px; margin: 2px; width: 160px;" ID="BtnGTOCAPP" runat="server" OnClick="BtnGTOCAPP_Click">Go To Export<i class="fas fa-undo"></i></i></asp:LinkButton>
                                    ...
                                    <div class="table-responsive p-0 mt-2" style="height: auto">
                                        <asp:GridView ID="GVINPUTAPP" runat="server" AutoGenerateColumns="False" CssClass="table table-bordered table-hover table-sm"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="exp_input_user" HeaderText="Created By" ItemStyle-HorizontalAlign="Center" />
                                                <asp:BoundField DataField="exp_input_date" HeaderText="Created Date" DataFormatString="{0:dd/MMM/yyyy}" ItemStyle-HorizontalAlign="Center" />
                                                <asp:BoundField DataField="exp_app_user" HeaderText="Approved By" ItemStyle-HorizontalAlign="Center" />
                                                <asp:BoundField DataField="exp_app_date" HeaderText="Approved Date" DataFormatString="{0:dd/MMM/yyyy}" ItemStyle-HorizontalAlign="Center" />
