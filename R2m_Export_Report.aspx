<%@ Page Title="Export Report" Language="C#" MasterPageFile="~/Master.master" AutoEventWireup="true" CodeFile="R2m_Export_Report.aspx.cs" Inherits="R2m_Export_Report" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="card card-info card-outline">
        <div class="card-header">
            <h3 class="card-title right animate-charcter"><i class="far fa-file-alt">Export Report</i></h3>
        </div>
        <div class="card-body">
                                            ...
                                            <div class="col-md-7">
                                                <div class="card card-info border border-info">
                                                    ...
                                                    <div class="card-body">
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <asp:RadioButton ID="RB1" runat="server" AutoPostBack="True" Font-Size="13px" GroupName="a" Text="Daily Export Report" OnCheckedChanged="RB1_CheckedChanged" /><br />
                                                                <asp:RadioButton ID="RB2" runat="server" AutoPostBack="True" Font-Size="13px" GroupName="a" Visible="true" OnCheckedChanged="RB2_CheckedChanged" Text="Closing Report By-Style Wise" /><br />
                                                                <asp:RadioButton ID="RB3" runat="server" AutoPostBack="True" Font-Size="13px" Visible="false" GroupName="a" Text="Export Report- Style Wise" OnCheckedChanged="RB3_CheckedChanged" /><br />
                                                                <asp:RadioButton ID="RB4" runat="server" AutoPostBack="True" Font-Size="13px" Visible="false" GroupName="a" OnCheckedChanged="RB4_CheckedChanged" Text="Export Report- PO Wise" /><br />
                                                                <asp:RadioButton ID="RB5" runat="server" AutoPostBack="True" Font-Size="13px" Visible="false" GroupName="a" Text="Export Closing Report- Style Wise" OnCheckedChanged="RB3_CheckedChanged" /><br />
                                                            </div>
