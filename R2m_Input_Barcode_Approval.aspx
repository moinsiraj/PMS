<%@ Page Title="Input Approval" Language="C#" MasterPageFile="~/Master.master" AutoEventWireup="true" CodeFile="R2m_Input_Barcode_Approval.aspx.cs" Inherits="R2m_Input_Barcode_Approval" %>
                        ...
                        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                            <ContentTemplate>
                                ...
                                <div class="mt-2" style="border: 1px solid #99CCFF; height: 40px; padding: 2px; background-color: rgba(40,167,69,0.28)">
                                    <asp:Button class="btn btn-success btn-sm float" Style="font-size: 14px; margin: 2px; width: 100px; background-color: #06D55C;" ID="btnBcom" runat="server" Text="Approve" OnClick="btnBcom_Click" OnClientClick="return confirm('Do you want to Approve the Challan ?');" />
                                    <asp:Button class="btn btn-success btn-sm float" Style="font-size: 14px; margin: 2px; width: 100px; background-color: #FF5733;" ID="BtnBCancel" runat="server" Text="Cancel" OnClick="BtnBCancel_Click" OnClientClick="return confirm('Do you want to Cancel this Challan ?');" />
