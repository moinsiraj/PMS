<%@ Page Title="Input Cut Panel" Language="C#" MasterPageFile="~/Master.master" AutoEventWireup="true" CodeFile="R2m_Input_Cut_Panel.aspx.cs" Inherits="R2m_Input_Cut_Panel" %>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-secondary">
                            ...
                            <div class="card-header">
                                <h3 class="card-title right animate-charcter"><i class="far fa-keyboard"></i>Line Wise Input Cut Panel-Data</h3>
                            </div>
                            <!--card-body -->
                            <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                              ...
                                              <%--  <asp:RequiredFieldValidator ID="RFVtxtremarks" runat="server" ControlToValidate="txtremarks" Display="None"
                                                    ErrorMessage="Input Remarks" ValidationGroup="a">*</asp:RequiredFieldValidator><asp:ValidatorCalloutExtender
                                                        ID="RFVtxtremarks_ValidatorCalloutExtender3" runat="server" Enabled="True" TargetControlID="RFVtxtremarks">
                                                    </asp:ValidatorCalloutExtender>--%>
                                            </div>
                                        </div>
