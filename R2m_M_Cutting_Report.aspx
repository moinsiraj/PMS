<%@ Page Title="Cutting Report" Language="C#" MasterPageFile="~/Master.master" AutoEventWireup="true" CodeFile="R2m_M_Cutting_Report.aspx.cs" Inherits="R2m_M_Cutting_Report" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="card card-info card-outline">
        <div class="card-header">
           <h3 class="card-title right animate-charcter"><i class="far fa-file-alt">Cutting Report</i></h3>
        </div>
        <div class="card-body">
                                            ...
                                            <div class="col-md-7">
                                                <div class="card card-info border border-info">
                                                    ...
                                                    <div class="card-body">
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <asp:RadioButton ID="RB2" runat="server" AutoPostBack="True" Font-Size="13px" GroupName="a" Text="Daily Cutting Report" OnCheckedChanged="RB2_CheckedChanged" /><br />
                                                                <asp:RadioButton ID="RB14" runat="server" AutoPostBack="True" Font-Size="13px" GroupName="a" OnCheckedChanged="RB14_CheckedChanged" Text="Cutting Summary By-D2D" /><br />
                                                                <asp:RadioButton ID="RB1" runat="server" AutoPostBack="True" Font-Size="13px" GroupName="a" Text="Cutting Report- Style Wise" OnCheckedChanged="RB1_CheckedChanged" /><br />
                                                                <asp:RadioButton ID="RB13" runat="server" AutoPostBack="True" Font-Size="13px" GroupName="a" OnCheckedChanged="RB13_CheckedChanged" Text="Cutting Report- PO Wise" /><br />
                                                                <asp:RadioButton ID="RB3" runat="server" AutoPostBack="True" Font-Size="13px" GroupName="a" OnCheckedChanged="RB3_CheckedChanged" Text="Cutting Report-Lay Wise" /><br />                                                                
                                                                <asp:RadioButton ID="RB4" runat="server" AutoPostBack="True" Font-Size="13px" GroupName="a" OnCheckedChanged="RB4_CheckedChanged" Text="Style Wise Closing- Cut To Input Report" /><br />
                                                            </div>
                                                            <div class="col-md-6">
                                                            </div>
                                                        </div>
