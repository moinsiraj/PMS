<%@ Page Title="Finishing Report" Language="C#" MasterPageFile="~/Master.master" AutoEventWireup="true" CodeFile="R2m_M_Finishing_Report.aspx.cs" Inherits="R2m_M_Finishing_Report" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="card card-info card-outline">
        <div class="card-header">
            <h3 class="card-title right animate-charcter"><i class="far fa-file-alt">Finishing Report</i></h3>
        </div>
        <div class="card-body">
                                            ...
                                            <div class="col-md-7">
                                                <div class="card card-info border border-info">
                                                    ...
                                                    <div class="card-body">
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <asp:RadioButton ID="RB1" runat="server" AutoPostBack="True" Font-Size="13px" GroupName="a" Text="Daily Finishing Report" OnCheckedChanged="RB1_CheckedChanged" /><br />
                                                                <asp:RadioButton ID="RB2" runat="server" AutoPostBack="True" Font-Size="13px" GroupName="a" OnCheckedChanged="RB2_CheckedChanged" Text="Finishing Summary By-D2D" /><br />
                                                                <asp:RadioButton ID="RB3" runat="server" AutoPostBack="True" Font-Size="13px" Visible="true" GroupName="a" Text="Finishing Report- Style Wise" OnCheckedChanged="RB3_CheckedChanged"  /><br />
                                                                <asp:RadioButton ID="RB4" runat="server" AutoPostBack="True" Font-Size="13px" Visible="true" GroupName="a" OnCheckedChanged="RB4_CheckedChanged" Text="Finishing Report- PO Wise" /><br />
                                                            </div>
