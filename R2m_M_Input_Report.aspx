<%@ Page Title="Input Report" Language="C#" MasterPageFile="~/Master.master" AutoEventWireup="true" CodeFile="R2m_M_Input_Report.aspx.cs" Inherits="R2m_M_Input_Report" %>
                                            ...
                                            <div class="col-md-7">
                                                <div class="card card-info border border-info">
                                                    ...
                                                    <div class="card-body">
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <asp:RadioButton ID="RB2" runat="server" AutoPostBack="True" Font-Size="13px" GroupName="a" Text="Line Wise Input Report-Daily" OnCheckedChanged="RB2_CheckedChanged" /><br />
                                                                <asp:RadioButton ID="RB4" runat="server" AutoPostBack="True" Font-Size="13px" GroupName="a" OnCheckedChanged="RB4_CheckedChanged" Text="Input To Sewing WIP Report-Daily" /><br />

                                                                <asp:RadioButton ID="RB14" runat="server" AutoPostBack="True" Font-Size="13px" GroupName="a" OnCheckedChanged="RB11_CheckedChanged" Text="Input Summary By-D2D" /><br />
                                                            ...
                                                            <div class="col-md-6">
                                                                <asp:RadioButton ID="RB1" runat="server" AutoPostBack="True" Font-Size="13px" GroupName="a" Text="Input Report- Style Wise" OnCheckedChanged="RB1_CheckedChanged" /><br />
                                                                <asp:RadioButton ID="RB13" runat="server" AutoPostBack="True" Font-Size="13px" GroupName="a" OnCheckedChanged="RB13_CheckedChanged" Text="Input Report- PO Wise" /><br />
                                                                <asp:RadioButton ID="RB3" runat="server" AutoPostBack="True" Font-Size="13px" GroupName="a" OnCheckedChanged="RB3_CheckedChanged" Text="Input Report- Style, PO And Line Wise" /><br />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
