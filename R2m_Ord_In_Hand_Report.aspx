<%@ Page Title="Order In Hand Report" Language="C#" MasterPageFile="~/Master.master" AutoEventWireup="true" CodeFile="R2m_Ord_In_Hand_Report.aspx.cs" Inherits="R2m_Ord_In_Hand_Report" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="card card-info card-outline">
        <div class="card-header">
            <h3 class="card-title"><i class="far fa-file-alt">Order In Hand Report</i></h3>
        </div>
        <div class="card-body">
                                            ...
                                            <div class="col-md-7">
                                                <div class="card card-info border border-info">
                                                    ...
                                                    <div class="card-body">
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <asp:RadioButton ID="RB1" runat="server" AutoPostBack="True" Font-Size="13px" GroupName="a" Text="Order In-hand Report" OnCheckedChanged="RB1_CheckedChanged" /><br />
                                                                <asp:RadioButton ID="RB2" runat="server" AutoPostBack="True" Font-Size="13px" GroupName="a" OnCheckedChanged="RB2_CheckedChanged" Text="Order In-hand Report-Merchandiser Wise" /><br />
                                                                <asp:RadioButton ID="RB3" runat="server" AutoPostBack="True" Font-Size="13px" GroupName="a" Text="Order In-hand Report- Buyer Wise" OnCheckedChanged="RB3_CheckedChanged" /><br />
                                                                <asp:RadioButton ID="RB4" runat="server" AutoPostBack="True" Font-Size="13px" GroupName="a" OnCheckedChanged="RB4_CheckedChanged" Text="Top-Bottom Summary-Month Wise" /><br />                                                            </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <asp:DropDownList ID="DDMERCHANT" runat="server" AutoPostBack="True"
