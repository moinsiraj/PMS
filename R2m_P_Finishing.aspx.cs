...
public partial class R2m_P_Finishing : System.Web.UI.Page
{
    ...
    {
        DDSIZE.DataSource = RADIDLL.get_Specfo_SmartcodedataTable("Select distinct Size_Id,Size from BundleTicket where ColorID='" + DDCOLOR.SelectedValue + "' and BTStyleCode='" + DDSTYLE.SelectedValue + "' and PO_No='" + DDPONO.SelectedItem.Text + "' and CountryID='" + DDCOUNT.SelectedValue + "' and BTDescription='SEWING QC OUT' order by Size");
    ...
    {
        {
            ...
            morucmd.Parameters.AddWithValue("@StageID", 9);
            morucmd.Parameters.AddWithValue("@Stage", "FINISHING QC PASS");
