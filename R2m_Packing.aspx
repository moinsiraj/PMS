<%@ Page Title="Packing" Language="C#" MasterPageFile="~/Master.master" AutoEventWireup="true" CodeFile="R2m_Packing.aspx.cs" Inherits="R2m_Packing" %>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-secondary">
                            ...
                            <div class="card-header">
                                <h3 class="card-title right animate-charcter"><i class="fas fa-tshirt"></i>Input Packing Data</h3>
                            </div>
                            <!--card-body -->
                            <div class="card-body">
                                                            ...
                                                            <div class="card-body">
                                                                <div class="border border-info p-1 mb-1">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-md-2">
                                                                            <div class="form-group">
                                                                                <label style="font-size: x-small">Packing Qty</label>
                                                                        ...
                                                                        <div class="col-md-2">
                                                                            <div class="form-group">
                                                                                <label style="font-size: x-small;">Total Packing Qty</label>
