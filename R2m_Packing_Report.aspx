<%@ Page Title="Packing Report" Language="C#" MasterPageFile="~/Master.master" AutoEventWireup="true" CodeFile="R2m_Packing_Report.aspx.cs" Inherits="R2m_Packing_Report" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="card card-info card-outline">
        <div class="card-header">
            <h3 class="card-title right animate-charcter"><i class="far fa-file-alt">Packing Report</i></h3>
        </div>
        <div class="card-body">
                                            ...
                                            <div class="col-md-7">
                                                <div class="card card-info border border-info">
                                                    ...
                                                    <div class="card-body">
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <asp:RadioButton ID="RB1" runat="server" AutoPostBack="True" Font-Size="13px" GroupName="a" Text="Daily Packing Report" OnCheckedChanged="RB1_CheckedChanged" /><br />
                                                                <asp:RadioButton ID="RB2" runat="server" AutoPostBack="True" Font-Size="13px" GroupName="a" OnCheckedChanged="RB2_CheckedChanged" Text="Cut to Packing Summary By-D2D" Visible="true" /><br />
                                                                <asp:RadioButton ID="RB3" runat="server" AutoPostBack="True" Font-Size="13px" Visible="true" GroupName="a" Text="Packing Report- Style Wise" OnCheckedChanged="RB3_CheckedChanged" /><br />
                                                                <asp:RadioButton ID="RB4" runat="server" AutoPostBack="True" Font-Size="13px" Visible="true" GroupName="a" OnCheckedChanged="RB4_CheckedChanged" Text="Packing Report- PO Wise" /><br />
                                                                <asp:RadioButton ID="RB5" runat="server" AutoPostBack="True" Font-Size="13px" Visible="true" GroupName="a" OnCheckedChanged="RB5_CheckedChanged" Text="Packing Report- Country Wise" /><br />
                                                            </div>
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label>PO</label>
                                                                    <asp:DropDownList ID="DDPO" runat="server" AutoPostBack="True" Visible="true" OnSelectedIndexChanged="DDPO_SelectedIndexChanged"
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label>Country</label>
                                                                    <asp:DropDownList ID="DDCOUNTRY" runat="server" AutoPostBack="True" Visible="true"
                                                                        CssClass="form-control form-control-sm">
                                                                    </asp:DropDownList>
