<%@ Page Title="Input Pre-Finishing" Language="C#" MasterPageFile="~/Master.master" AutoEventWireup="true" CodeFile="R2m_Pre_Finishing.aspx.cs" Inherits="R2m_Pre_Finishing" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <script type="text/javascript">
        function SewPro() {
            ...
            var CutQty = document.getElementById('<%=txtOrQty.ClientID %>').value;
           ...
           function CheckValue() {
             ...
             var SewingQty = parseInt(document.getElementById('<%=TxtQty.ClientID %>').value);
               ...
               if (SewingQty > SewBalance) {
                 alert('Pre-Finishing Qty Cannot Be Greater Than Balance Qty');
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-secondary">
                            ...
                            <div class="card-header">
                                <h3 class="card-title"><i class="fas fa-tshirt"></i>Input Pre-Finising Data</h3>
                            </div>
                            <!--card-body -->
                            <div class="card-body">
                                                            ...
                                                            <div class="card-body">
                                                                <div class="border border-info p-1 mb-1">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-md-2">
                                                                            <div class="form-group">
                                                                                <label style="font-size: x-small">Pre-Finising Qty</label>
                                                                        ...
                                                                        <div class="col-md-4">
                                                                            <div class="form-group">
                                                                                <label style="font-size: x-small;">Total Pre-Finishing Qty</label>
                                                                                
                                                                                <asp:TextBox ID="TxtCutQty" Style="margin-top: -6px" runat="server" onkeyup="SewPro()" CssClass="form-control form-control-sm" Enabled="False" Visible="False"></asp:TextBox>
                                                                        ...
                                                                        <div class="col-md-2">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <asp:TextBox ID="TxtSewBal" onkeyup="SewPro()"  Style="margin-top: -6px" runat="server" CssClass="form-control form-control-sm" Enabled="False"></asp:TextBox>
