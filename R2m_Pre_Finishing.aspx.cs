...
public partial class R2m_Pre_Finishing : System.Web.UI.Page
{
    ...
    {
        DDSTAGE.DataSource = RADIDLL.get_R2m_PMS_dataTable("SELECT [st_id],[st_des],[st_com] FROM [dbo].[Mr_Stage] where st_id=7 order by st_asc");
    ...
    {
        DataTable RADIDT1 = RADIDLL.get_Specfo_SmartcodedataTable("SELECT SUM(BTQty) AS WQty FROM dbo.BundleTicket where  Size_Id='" + DDSIZE.SelectedValue + "' and ColorID='" + DDCOLOR.SelectedValue + "' and BTStyleCode='" + DDSTYLE.SelectedValue + "' and PoLot='" + DDPONO.SelectedValue + "' and BTOperationNo=7");
    ...
    {
        DataTable RADIDT1 = RADIDLL.get_Specfo_SmartcodedataTable("SELECT SUM(BTQty) AS PQty FROM dbo.BundleTicket where Size_Id='" + DDSIZE.SelectedValue + "' and ColorID='" + DDCOLOR.SelectedValue + "' and BTStyleCode='" + DDSTYLE.SelectedValue + "' and PoLot='" + DDPONO.SelectedValue + "' and BTOperationNo=7");
        if (RADIDT1.Rows.Count > 0)
        {
