<%@ Page Title="Rejection Input" Language="C#" MasterPageFile="~/Master.master" AutoEventWireup="true" CodeFile="R2m_Qlt_Daily_Rejection_Input.aspx.cs" Inherits="R2m_Qlt_Daily_Rejection_Input" %>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-secondary">
                            ...
                            <div class="card-header">
                                <h3 class="card-title right animate-charcter"><i class="far fa-keyboard"></i>Daily Rejection Entry</h3>
                            </div>
                            <!--card-body -->
                            <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <asp:DropDownList ID="DDQTLSEC" runat="server" Style="margin-top: -6px"
                                                    CssClass="form-control form-control-sm" OnSelectedIndexChanged="DDQTLSEC_SelectedIndexChanged" AutoPostBack="True">
                                                </asp:DropDownList>
                                                <asp:RequiredFieldValidator ID="RFVCUT" runat="server" ControlToValidate="DDQTLSEC" Display="None"
                                                    ErrorMessage="Please Quality Section" ValidationGroup="a">*</asp:RequiredFieldValidator><asp:ValidatorCalloutExtender
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <label style="font-size: x-small">Rejection Type</label>

                                                <asp:DropDownList ID="DDREJType" runat="server" Style="margin-top: -6px"
                                                    CssClass="form-control form-control-sm">
                                                </asp:DropDownList>


                                                <asp:RequiredFieldValidator ID="RFV08" runat="server" ControlToValidate="DDREJType" Display="None"
                                                    ErrorMessage="Please Select Rejection Category" ValidationGroup="a">*</asp:RequiredFieldValidator><asp:ValidatorCalloutExtender
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <label style="font-size: x-small">Total Check Qty</label>

                                                <asp:TextBox ID="txtttlChkQty" Style="margin-top: -6px" runat="server" CssClass="form-control form-control-sm" MaxLength="4"></asp:TextBox>

                                                <asp:FilteredTextBoxExtender ID="txtttlChkQty_FilteredTextBoxExtender"
                                                    runat="server" Enabled="True" TargetControlID="txtttlChkQty" ValidChars="0123456789"></asp:FilteredTextBoxExtender>

                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <label style="font-size: x-small">QC Passed Qty</label>

                                                <asp:TextBox ID="txtqcpassqty" Style="margin-top: -6px" runat="server" CssClass="form-control form-control-sm" MaxLength="4"></asp:TextBox>
                                                <asp:FilteredTextBoxExtender ID="txtqcpassqty_FilteredTextBoxExtender1"
                                            ...
                                            <div class="table-responsive p-0" style="height: auto;">
                                                ...
                                                <asp:GridView ID="GVSIZERATIO" runat="server" AutoGenerateColumns="False" CssClass="table table-bordered table-hover table-sm" Font-Size="12px" OnRowDataBound="GVSIZERATIO_RowDataBound">
                                                    <Columns>
                                                        ...
                                                        <%--               <asp:TemplateField HeaderText="Total Cut Qty" Visible="true">
                                                            <ItemTemplate>
                                                        ...
                                                        <asp:TemplateField HeaderText="Cut Rej Qty" Visible="true">
                                                            <ItemTemplate>
                                                                <asp:TextBox ID="txtcutreject" runat="server" CssClass="form-control form-control-sm" Style="height: 20px; font-size-adjust: inherit;"></asp:TextBox>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>

                                                        <asp:TemplateField HeaderText="Total Cut Rej Qty" Visible="true">
                                                            <ItemTemplate>
                                                                <asp:TextBox ID="txtcutrej" runat="server" CssClass="form-control form-control-sm" Style="height: 20px; font-size-adjust: inherit;" Enabled="False"></asp:TextBox>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>

                                                        <%--  <asp:TemplateField HeaderText="Total Input Qty" Visible="true">
                                                            <ItemTemplate>
                                                        ...
                                                        <%--  <asp:TemplateField HeaderText="Total Balance Qty" Visible="true">
                                                            <ItemTemplate>
                                                        ...
                                                        <asp:TemplateField HeaderText="Sewing Rej Qty">
                                                            <ItemTemplate>
                                                                <asp:TextBox ID="txtSRejQty" runat="server" CssClass="form-control form-control-sm" onkeyup="FetchData(this)" Style="height: 20px; font-size-adjust: inherit"></asp:TextBox>
                                                                <asp:FilteredTextBoxExtender ID="txtSRejQty_FilteredTextBoxExtender"
                                                                    runat="server" Enabled="True" TargetControlID="txtSRejQty" ValidChars="0123456789"></asp:FilteredTextBoxExtender>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="Total Sewing Rejection" Visible="true">
                                                            <ItemTemplate>
                                                                <asp:TextBox ID="textsewrej" runat="server" CssClass="form-control form-control-sm" Style="height: 20px; font-size-adjust: inherit;" Enabled="False"></asp:TextBox>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>

                                                        <asp:TemplateField HeaderText="Finishing Rej Qty">
                                                            <ItemTemplate>
                                                                <asp:TextBox ID="txtFejQty" runat="server" CssClass="form-control form-control-sm" Style="height: 20px; font-size-adjust: inherit"></asp:TextBox>
                                                                <asp:FilteredTextBoxExtender ID="txtFejQty_FilteredTextBoxExtender"
                                                                    runat="server" Enabled="True" TargetControlID="txtFejQty" ValidChars="0123456789"></asp:FilteredTextBoxExtender>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>

                                                        <asp:TemplateField HeaderText="Total Finishing Rej Qty">
                                                            <ItemTemplate>
                                                                <asp:TextBox ID="txtTFejQty" runat="server" CssClass="form-control form-control-sm" Style="height: 20px; font-size-adjust: inherit" Enabled="False"></asp:TextBox>
                                                                <asp:FilteredTextBoxExtender ID="txtTFejQty_FilteredTextBoxExtender"
                                                                    runat="server" Enabled="True" TargetControlID="txtTFejQty" ValidChars="0123456789"></asp:FilteredTextBoxExtender>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>

                                                        <asp:TemplateField HeaderText="Wash Rej Qty">
                                                            <ItemTemplate>
                                                                <asp:TextBox ID="txtwashrejQty" runat="server" CssClass="form-control form-control-sm" Style="height: 20px; font-size-adjust: inherit"></asp:TextBox>
                                                                <asp:FilteredTextBoxExtender ID="txtwashrejQty_FilteredTextBoxExtender"
                                                                    runat="server" Enabled="True" TargetControlID="txtwashrejQty" ValidChars="0123456789"></asp:FilteredTextBoxExtender>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="Total Wash Rej Qty">
                                                            <ItemTemplate>
                                                                <asp:TextBox ID="txtTwashrejQty" runat="server" CssClass="form-control form-control-sm" Style="height: 20px; font-size-adjust: inherit" Enabled="False"></asp:TextBox>
                                                                <asp:FilteredTextBoxExtender ID="txtTwashrejQty_FilteredTextBoxExtender"
                                                                    runat="server" Enabled="True" TargetControlID="txtTwashrejQty" ValidChars="0123456789"></asp:FilteredTextBoxExtender>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                    </Columns>
