<%@ Page Title="Reject Type" Language="C#" MasterPageFile="~/Master.master" AutoEventWireup="true" CodeFile="R2m_Reject_Type.aspx.cs" Inherits="R2m_Reject_Type" %>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-secondary">
                            ...
                            <div class="card-header">
                                <h3 class="card-title"><i class="fas fa-diagnoses"></i>Create Reject</h3>
                            </div>
                            <!--card-body -->
                            <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <asp:DropDownList ID="DDREJECT" runat="server" OnSelectedIndexChanged="DDREJECT_SelectedIndexChanged" AutoPostBack="true"
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label style="font-size: x-small;">Reject Type</label>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <fieldset class="border border-info p-2 mt-1">
                                                <legend class="w-auto border border-info p-1 text-info" style="font-size: 12px; border-top-left-radius: 10px; border-bottom-right-radius: 10px;">Reject View</legend>
                                                <div class="table-responsive p-0" style="height: auto;">
                                                    <!--Gridview-->
                                                    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                                        <ContentTemplate>
                                                            <asp:GridView ID="GVREJECT" runat="server" AutoGenerateColumns="False" CssClass="table table-bordered table-hover table-sm"
                                                                AllowPaging="True" OnPageIndexChanging="GVREJECT_PageIndexChanging" OnRowCommand="GVREJECT_RowCommand"
                                                                PageSize="8">
                                                                <Columns>

                                                                    <asp:TemplateField HeaderText="ID #">
                                                                        <ItemTemplate>
                                                                            <asp:Label ID="lbldfId" runat="server" Text='<%# Bind("RejID") %>'></asp:Label>
                                                                        </ItemTemplate>
                                                                    </asp:TemplateField>

                                                                    <asp:BoundField DataField="RejectType" HeaderText="Reject Type" ItemStyle-HorizontalAlign="Left" />
                                                                    <asp:BoundField DataField="ScName" HeaderText="Section" ItemStyle-HorizontalAlign="Right" />
                                                                    <asp:BoundField DataField="RejRemarks" HeaderText="Remarks" ItemStyle-HorizontalAlign="Right" />
                                                                    <asp:BoundField DataField="RejentUser" HeaderText="Created By" ItemStyle-HorizontalAlign="Right" />
                                                                    <asp:BoundField DataField="RejentDate" HeaderText="Created Date" DataFormatString="{0:dd/MMM/yyyy}" ItemStyle-HorizontalAlign="Right" />
                                                                    <asp:TemplateField Visible="false">
                                                                        <ItemTemplate>
                                                                            <asp:HiddenField ID="HiddenField1" runat="server" Visible="true" Value='<%#Bind("RejID")%>' />
                                                                        </ItemTemplate>
                                                                    </asp:TemplateField>
