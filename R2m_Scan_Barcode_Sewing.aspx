<%@ Page Title="Scan Sewing Barcode" Language="C#" AutoEventWireup="true" CodeFile="R2m_Scan_Barcode_Sewing.aspx.cs" Inherits="R2m_Scan_Barcode_Sewing" %>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card card-secondary">
                                ...
                                <div class="card-header">
                                    <h3 class="card-title"><i class="fa fa-barcode fa-xl p-2" style="color: black" aria-hidden="true"></i>Sewing QC Pass-Barcode Scan</h3>
                                                ...
                                                <ContentTemplate>
                                                    <asp:GridView ID="GVSCANVIEW" runat="server" AutoGenerateColumns="False" CssClass="table table-bordered table-hover table-sm" Font-Size="12px" AllowPaging="True" PageSize="100">
                                                        <Columns>
                                                            ...
                                                            <asp:BoundField DataField="BTPrintDate" HeaderText="Scan Date" />
                                                            <asp:BoundField DataField="BTScanBy" HeaderText="Scan User" />
