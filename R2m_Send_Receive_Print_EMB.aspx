<%@ Page Title="Input Print/EMB" Language="C#" MasterPageFile="~/Master.master" AutoEventWireup="true" CodeFile="R2m_Send_Receive_Print_EMB.aspx.cs" Inherits="R2m_Send_Receive_Print_EMB" %>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-secondary">
                            ...
                            <div class="card-header">
                                 <h3 class="card-title right animate-charcter"><i class="fas fa-paint-brush"></i>Input Print and EMB-Data</h3>
                            </div>
                            <!--card-body -->
                            <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <%--    <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <asp:DropDownList ID="DDCOUNT" runat="server" AutoPostBack="True"
                                                    CssClass="form-control form-control-sm" OnSelectedIndexChanged="DDCOUNT_SelectedIndexChanged">
                                                </asp:DropDownList>
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <asp:DropDownList ID="DDSTAGE" runat="server" AutoPostBack="True" Style="margin-top: -6px" OnSelectedIndexChanged="DDSTAGE_SelectedIndexChanged"
                                                    CssClass="form-control form-control-sm">
                                                </asp:DropDownList>
                                            ...
                                            <fieldset class="border border-info p-2 mb-1">
                                                ...
                                                <div class="table-responsive p-0" style="height: auto;">
                                                        ...
                                                        <ContentTemplate>
                                                            <asp:GridView ID="GVSIZERATIO" runat="server" OnRowDataBound="GVSIZERATIO_RowDataBound" AutoGenerateColumns="False" CssClass="table table-bordered table-hover table-sm" Font-Size="12px">
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="Total Sent Quantity" Visible="true">
                                                                        <ItemTemplate>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="Total Send Balance Quantity" Visible="true">
                                                                        <ItemTemplate>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="Total Received Quantity" Visible="true">
                                                                        <ItemTemplate>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="Total Received Balance Quantity" Visible="true">
                                                                        <ItemTemplate>
                                                    ...
                                                    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                                        <ContentTemplate>
                                                            <asp:GridView ID="GVPRINT" runat="server" OnRowDataBound="GVPRINT_RowDataBound" AutoGenerateColumns="False" CssClass="table table-bordered table-hover table-sm" Font-Size="12px">
                                                                <Columns>
                                                                    <asp:TemplateField HeaderText="StyleID" Visible="false">
                                                                        <ItemTemplate>
                                                                            <asp:Label ID="lblStyleID" runat="server" Text='<%# Eval("nStyleID") %>'></asp:Label>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="Cut Quantity" Visible="false">
                                                                        <ItemTemplate>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="Cut Quantity" Visible="true">
                                                                        <ItemTemplate>
                                    ...
                                    <div class="mt-2" style="border: 1px solid #99CCFF; height: 40px; padding: 2px; background-color: rgba(40,167,69,0.28)">
                                        <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                                            <ContentTemplate>
                                                ...
                                                <asp:LinkButton class="btn btn-success btn-sm float-right" Style="background-color: #5E5A80" ID="BtnPrintRcvd" Width="250px" runat="server" Text="" OnClick="BtnPrintRcvd_Click" ValidationGroup="a">SavePNTR  <i class="far fa-plus-square"></i></asp:LinkButton>
                                                <asp:LinkButton class="btn btn-success btn-sm float-right" Style="background-color: #5E5A80" ID="BtnPrintSend" Width="250px" runat="server" Text="" OnClick="BtnPrintSend_Click" ValidationGroup="a">SavePNTS  <i class="far fa-plus-square"></i></asp:LinkButton>
