<%@ Page Title="Input Sewing Production Data" Language="C#" MasterPageFile="~/Master.master" AutoEventWireup="true" CodeFile="R2m_Sewing_Production.aspx.cs" Inherits="R2m_Sewing_Production" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <script type="text/javascript">
        function SewPro() {
            ...
            if (SewpQty > SewBalance) {
                alert('Sewing Qty Cannot Be Greater Than Balance Qty');
    ...
    <script type="text/javascript">
        function HLPro() {
            ...
            var lproQty = document.getElementById('<%=txtprePqty.ClientID %>').value;
            lproQty = parseFloat(lproQty);
            if (isNaN(lproQty))
                lproQty = 0;



            var mult = (SewpQty + lproQty);
            document.getElementById('<%=txthpbal.ClientID %>').value = mult;
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-secondary">
                            ...
                            <div class="card-header">
                                <h3 class="card-title right animate-charcter"><i class="fas fa-tshirt"></i>Input Sewing Production Data</h3>
                            </div>
                            <!--card-body -->
                            <div class="card-body">
                                      ...
                                      <%--  <div class="col-md-3">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <asp:TextBox ID="TxtHour" Style="margin-top: -6px" runat="server" CssClass="form-control form-control-sm" MaxLength="2" AutoPostBack="True" OnTextChanged="TxtHour_TextChanged"></asp:TextBox>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <asp:TextBox ID="TXTCUTDATE" Style="margin-top: -6px; background-color: #F0FA08" runat="server" CssClass="form-control form-control-sm danger" Enabled="false"></asp:TextBox>
                                                            ...
                                                            <div class="card-body">
                                                                <div class="border border-info p-1 mb-1">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-md-2">
                                                                            <div class="form-group">
                                                                                <label style="font-size: x-small">Sewing Qty</label>

                                                                                <asp:TextBox ID="TxtQty" Style="margin-top: -6px" runat="server" onkeyup="SewPro(),HLPro()" CssClass="form-control form-control-sm" MaxLength="3"></asp:TextBox>
                                                                        ...
                                                                        <div class="col-md-2">
                                                                            <div class="form-group">
                                                                                <label style="font-size: x-small;">Total Input Qty</label>
                                                                        ...
                                                                        <div class="col-md-2">
                                                                            <div class="form-group">
                                                                                <label style="font-size: x-small;">Total Production Qty</label>
                                    ...
                                    <div class="mt-2" style="border: 1px solid #99CCFF; height: 40px; padding: 2px; background-color: rgba(40,167,69,0.28)">
                                        <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                                            <ContentTemplate>
                                                ...
                                                <asp:LinkButton class="btn btn-success btn-sm float-right" Style="font-size: 14px; margin: 2px; width: 160px; background-color: #079AA8" ID="BtnCust" runat="server" data-toggle="modal" data-target="#add_CustomerInfo" data-url="" data-keyboard="false" data-backdrop="static">Style Ship Out <i class="fas fa-sort-amount-down-alt"></i></asp:LinkButton>
                                                <asp:TextBox ID="txtprePqty" runat="server" Enabled="False" onkeyup="SewPro(),HLPro()" Visible="true" Width="120px"></asp:TextBox>

                                                <asp:TextBox ID="txthpbal" runat="server" Enabled="False" Visible="true" Width="120px"></asp:TextBox>
                                                <asp:TextBox ID="txttotal" runat="server" Enabled="False" Visible="true" Width="120px"></asp:TextBox>
        ...
        <div class="modal-dialog modal-dialog-scrollable modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="CustomerInfo_Label">Style Ship Out</h5>
                    ...
                    <asp:UpdatePanel ID="UpdatePanel25" runat="server">
                        <ContentTemplate>
                            <div class="form-group col-md-8">
                                <label>Buyer</label>
                                <asp:DropDownList ID="DDBUYER" runat="server" CssClass="form-control form-control-sm" AutoPostBack="True" OnSelectedIndexChanged="DDBUYER_SelectedIndexChanged">
                                </asp:DropDownList>
                                <asp:RequiredFieldValidator ID="RFVDDBUYER" runat="server" ControlToValidate="DDBUYER"
                                    Display="None" ErrorMessage="Select Buyer" ValidationGroup="M">*</asp:RequiredFieldValidator>
                                <asp:ValidatorCalloutExtender ID="RFVDDBUYER_ValidatorCalloutExtender1"
                                    runat="server" Enabled="True" TargetControlID="RFVDDBUYER">
                                </asp:ValidatorCalloutExtender>
                            </div>
                            <div class="form-group col-md-8">
                                <label>Style No</label>
                                <asp:DropDownList ID="DDSTYLE1" runat="server" CssClass="form-control form-control-sm">
                                </asp:DropDownList>
                                <asp:RequiredFieldValidator ID="RFVM1" runat="server" ControlToValidate="DDSTYLE1"
                                    Display="None" ErrorMessage="Select Style" ValidationGroup="M">*</asp:RequiredFieldValidator>
                            ...
                            <div class="mt-2" style="border: 1px solid #99CCFF; border-radius: 5px; height: 40px; padding: 2px; background-color: rgb(255, 255, 255)">
                                ...
                                <asp:LinkButton ID="BtnActive" runat="server" class="btn btn-success btn-sm float-right" Style="width: 160px" OnClick="BtnActive_Click" ValidationGroup="M">Shift Out <i class="far fa-check-circle"></i></asp:LinkButton>
                                <asp:LinkButton ID="BtnInactive" runat="server" class="btn btn-danger btn-sm float-right" Style="width: 160px" OnClick="BtnInActive_Click" ValidationGroup="M">Not Shift Out<i class="fas fa-times"></i></asp:LinkButton>
