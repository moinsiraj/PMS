...
public partial class Sewing_Report_Mr_Daily_Finishing_Rpt : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            SqlDataAdapter cmd = new SqlDataAdapter("Mr_Daily_Finishing_Rpt", R2m_PMS_cnn);
            ...
            cmd.Fill(ds, "Mr_Daily_Finishing_Rpt");
            ...
            reportParameters.Add(new ReportParameter("Title", "Daily Floor Wise Finishing Report- Date: " + FromDate.ToString() + ""));
