...
public partial class Sewing_Report_Mr_Daily_Packing_Rpt : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            SqlDataAdapter cmd = new SqlDataAdapter("Mr_Daily_Packing_Rpt", R2m_PMS_cnn);
            ...
            cmd.Fill(ds, "Mr_Daily_Packing_Rpt");
            ...
            reportParameters.Add(new ReportParameter("Title", "Daily Floor Wise Packing Report- Date: " + FromDate.ToString() + ""));
