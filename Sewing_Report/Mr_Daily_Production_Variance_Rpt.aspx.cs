...
public partial class Sewing_Report_Mr_Daily_Production_Variance_Rpt : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            reportParameters.Add(new ReportParameter("Title", "Daily Production Variance Report- Date: " + FromDate.ToString() + ""));
