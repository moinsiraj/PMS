...
public partial class Cutting_Report_Mr_Daily_Sewing_Rpt : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            SqlDataAdapter cmd = new SqlDataAdapter("Mr_Daily_Sewing_Rpt", R2m_PMS_cnn);
            ...
            cmd.Fill(ds, "Mr_Daily_Sewing_Rpt");
            ...
            reportParameters.Add(new ReportParameter("Title", "Daily Line Wise Sewing Report- Date: " + FromDate.ToString() + ""));
