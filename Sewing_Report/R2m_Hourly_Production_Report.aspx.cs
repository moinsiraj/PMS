...
public partial class Sewing_Report_R2m_Hourly_Production_Report : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            string COM1 = Session["COM1"].ToString();
            string Date = Session["Date"].ToString();
            //string COM = Session["Com"].ToString();
            ReportViewer1.ProcessingMode = ProcessingMode.Local;
            SqlDataAdapter cmd = new SqlDataAdapter("Sp_rsHrsProdcutionReport_new", R2m_Smart_cnn);
            ...
            cmd.Fill(ds, "Sp_rsHrsProdcutionReport_new");
            ...
            reportParameters.Add(new ReportParameter("Title", "Hourly Production Report- Company Name: " + COM1.ToString() + ", Date: " + Date.ToString() + ""));
