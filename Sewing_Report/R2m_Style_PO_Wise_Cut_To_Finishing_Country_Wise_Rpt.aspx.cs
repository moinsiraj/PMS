...
public partial class Sewing_Report_R2m_Style_PO_Wise_Cut_To_Finishing_Country_Wise_Rpt : System.Web.UI.Page
{
    moruDLL RADIDLL = new moruDLL();
    moruBLL RADIBLL = new moruBLL();
    SqlConnection R2m_SpecFo_Cnn = moruGetway.SpecFo;
    SqlConnection cnn = moruGetway.Barcoding;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            SqlDataAdapter cmd = new SqlDataAdapter("Mr_Style_PO_Country_Wise_Cut_To_Finishied_Qty", cnn);
            ...
            cmd.Fill(ds, "Mr_Style_PO_Country_Wise_Cut_To_Finishied_Qty");
            ...
            reportParameters.Add(new ReportParameter("Title", "Style, PO and Country Wise Cut To Pack Report"));
